...
def simulate_all_situations(selected_pitcher: str, profiles: Dict, mdl: Any, leverage_from_state: callable = leverage_from_state):
    ...
    hardcoded_data = [
        ...
        ["Barna, Cal",     "Early",  "Down Lots",    -2.2158362e-02, 2.2144631e-01,  116.78416, 22.144631, 25],  # 17
        ...
        ["Barna, Cal",     "Late",   "Down Lots",    -8.4732815e-02, 5.1454150e-02,  118.52672,  5.145415, 25],  # 22
        ...
        ["Barna, Cal",     "Middle", "Down Lots",    -6.3738632e-02, 9.7047280e-02,  118.62614,  9.704728, 25],  # 27
        ...
        ["Dilhoff, Parker","Early",  "Down Little",  -2.71284822e-01, 3.1508555e-01, 107.84386, 31.508555, 25],  # 61
        ["Dilhoff, Parker","Early",  "Down Lots",    -1.91953920e-01, 1.9575620e-01, 115.77695, 19.575620, 25],  # 62
        ["Dilhoff, Parker","Early",  "Tight",        -1.57098436e-01, 4.3567419e-01, 119.26250, 43.567419, 25],  # 63
        ["Dilhoff, Parker","Early",  "Up Little",    -2.86585568e-01, 2.4703822e-01, 106.31378, 24.703822, 25],  # 64
        ["Dilhoff, Parker","Early",  "Up Lots",      -1.72884222e-01, 6.5039630e-02, 117.68392,  6.503963, 25],  # 65
        ...
        ["Dilhoff, Parker","Middle", "Down Little",  -2.99723382e-01, 3.1076812e-01, 105.00000, 31.076812, 25],  # 71
        ["Dilhoff, Parker","Middle", "Down Lots",    -1.96035909e-01, 8.8014900e-02, 115.36875,  8.801490, 25],  # 72
        ["Dilhoff, Parker","Middle", "Tight",        -2.10189954e-01, 2.6970520e-01, 113.95334, 26.970520, 25],  # 73
        ["Dilhoff, Parker","Middle", "Up Little",    -2.07349832e-01, 2.2862811e-01, 114.23736, 22.862811, 25],  # 74
        ["Dilhoff, Parker","Middle", "Up Lots",      -1.52400630e-01, 2.9257890e-02, 119.73228,  2.925789, 25],  # 75
        ...
        ["Evangelista, Jase","Late", "Down Little",  -5.1692773e-02, 1.2550673e-01, 114.83072, 12.550673, 25],  # 96
        ...
        ["Evangelista, Jase","Late", "Up Little",     1.3975460e-03, 6.4193110e-02, 115.13975,  6.419311, 25],  # 99
        ...
        ["Foxson, Tate",   "Early",  "Down Lots",     4.2912760e-02, 2.3274282e-01, 104.29128, 23.274282, 25],  # 107
        ["Foxson, Tate",   "Early",  "Tight",         5.0396039e-02, 4.1854119e-01, 101.03960, 41.854119, 25],  # 108
        ...
        ["Foxson, Tate",   "Late",   "Down Little",  -1.37256456e-01, 1.6057482e-01,  107.27435, 16.057482, 25],  # 111
        ["Foxson, Tate",   "Late",   "Down Lots",    -4.2437091e-02, 5.4624990e-02, 105.75629,  5.462499, 25],  # 112
        ["Foxson, Tate",   "Late",   "Tight",        -1.12028930e-01, 1.5665613e-01,  108.79711, 15.665613, 25],  # 113
        ...
        ["Gomberg, Jacob", "Early",  "Down Little",  -3.47878043e-01, 2.1544712e-01, 119.57666, 21.544712, 25],  # 121
        ["Gomberg, Jacob", "Early",  "Down Lots",    -3.29384195e-01, 2.2066630e-01, 127.42604, 22.066630, 25],  # 122
        ["Gomberg, Jacob", "Early",  "Tight",        -2.53772151e-01, 3.7207944e-01, 103.98724, 37.207944, 25],  # 123
        ["Gomberg, Jacob", "Early",  "Up Little",    -3.43644617e-01, 1.7699410e-01,  95.00000, 17.699410, 25],  # 124 (min -> 95)
        ["Gomberg, Jacob", "Early",  "Up Lots",      -2.64266056e-01, 5.2601990e-02, 102.93785,  5.260199, 25],  # 125
        ["Gomberg, Jacob", "Late",   "Down Little",  -3.11895424e-01, 1.3528160e-01,  98.17492, 13.528160, 25],  # 126
        ["Gomberg, Jacob", "Late",   "Down Lots",    -2.74083606e-01, 4.3119620e-02, 101.95610,  4.311962, 25],  # 127
        ["Gomberg, Jacob", "Late",   "Tight",        -2.42524944e-01, 1.3147473e-01, 105.11197, 13.147473, 25],  # 128
        ["Gomberg, Jacob", "Late",   "Up Little",    -1.93856447e-01, 5.7258740e-02, 109.97882,  5.725874, 25],  # 129
        ["Gomberg, Jacob", "Late",   "Up Lots",      -1.88560971e-01, 4.7043600e-02, 110.50836,  4.704360, 25],  # 130
        ["Gomberg, Jacob", "Middle", "Down Little",  -3.18672959e-01, 2.4310491e-01,  97.49716, 24.310491, 25],  # 131
        ["Gomberg, Jacob", "Middle", "Down Lots",    -3.31504959e-01, 8.6444180e-02,  96.21396,  8.644418, 25],  # 132
        ["Gomberg, Jacob", "Middle", "Tight",        -2.17636436e-01, 1.9846577e-01, 107.60082, 19.846577, 25],  # 133
        ["Gomberg, Jacob", "Middle", "Up Little",    -2.58833340e-01, 1.7143995e-01, 103.48113, 17.143995, 25],  # 134
        ["Gomberg, Jacob", "Middle", "Up Lots",      -2.32168221e-01, 2.6738640e-02, 106.14764,  2.673864, 25],  # 135

        ["Lane, Carson",   "Early",  "Down Little",   3.8370610e-03, 2.3736993e-01, 110.88371, 23.736993, 25],  # 136
        ["Lane, Carson",   "Early",  "Down Lots",     4.0979291e-02, 2.6958592e-01, 114.09793, 26.958592, 25],  # 137
        ["Lane, Carson",   "Early",  "Tight",         6.6179487e-02, 3.8096613e-01, 122.33348, 18.351142, 25],  # 138 (note: MeanStopper row 150 clarifies later)
        ["Lane, Carson",   "Early",  "Up Little",    -3.2307496e-02, 1.8456456e-01, 107.26925, 18.456456, 25],  # 139
        ["Lane, Carson",   "Early",  "Up Lots",      -5.3039861e-02, 5.1638730e-02, 104.69601,  5.163873, 25],  # 140
        ["Lane, Carson",   "Late",   "Down Little",  -2.0711187e-02, 1.1620132e-01, 108.42888, 11.620132, 25],  # 141
        ["Lane, Carson",   "Late",   "Down Lots",    -6.1021417e-02, 4.6637520e-02, 103.89786,  4.663752, 25],  # 142
        ["Lane, Carson",   "Late",   "Tight",         4.7657710e-02, 1.0926715e-01, 115.26577, 10.926715, 25],  # 143
        ["Lane, Carson",   "Late",   "Up Little",    -2.1118825e-02, 6.8361860e-02, 108.38812,  6.836186, 25],  # 144
        ["Lane, Carson",   "Late",   "Up Lots",      -4.5542440e-02, 4.2298100e-02, 105.44576,  4.229810, 25],  # 145
        ["Lane, Carson",   "Middle", "Down Little",   2.5013924e-02, 2.6727461e-01, 113.00139, 26.727461, 25],  # 146
        ["Lane, Carson",   "Middle", "Down Lots",    -2.9670672e-02, 1.1966630e-01, 107.03293, 11.966630, 25],  # 147
        ["Lane, Carson",   "Middle", "Tight",         1.18334762e-01, 1.8351142e-01, 122.33348, 18.351142, 25],  # 148
        ["Lane, Carson",   "Middle", "Up Little",    -1.9222583e-02, 1.7640330e-01, 108.57774, 17.640330, 25],  # 149
        ...
        ["Lueck, Reese",   "Late",   "Down Lots",    -4.2353675e-02, 6.1867470e-02, 98.76463,  6.186747, 25],  # 157
        ["Lueck, Reese",   "Late",   "Tight",        -9.3419062e-02, 1.6813185e-01, 100.65809, 16.813185, 25],  # 158
        ["Lueck, Reese",   "Late",   "Up Little",    -2.3257295e-02, 8.0338340e-02, 98.67427,  8.033834, 25],  # 159
        ["Lueck, Reese",   "Late",   "Up Lots",      -3.7851515e-02, 6.5149750e-02, 97.21485,  6.514975, 25],  # 160
        ["Lueck, Reese",   "Middle", "Down Little",  -5.0739307e-02, 2.8957773e-01, 96.92607, 28.957773, 25],  # 161
        ...
        ["Marton, Ryan",   "Late",   "Down Little",  -2.19630445e-01, 2.0231827e-01,  112.03696, 20.231827, 25],  # 186
        ["Marton, Ryan",   "Late",   "Down Lots",    -5.8015925e-02, 5.4652950e-02, 104.19841,  5.465295, 25],  # 187
        ["Marton, Ryan",   "Late",   "Tight",        -1.80887424e-01, 1.8479817e-01,  111.91126, 18.479817, 25],  # 188
        ...
        ["Ong, Felix",     "Early",  "Down Little",  -1.9420928e-02, 2.6498547e-01, 115.05791, 26.498547, 25],  # 196
        ...
        ["Ong, Felix",     "Early",  "Up Little",    -5.5649834e-02, 2.0923799e-01, 114.43502, 20.923799, 25],  # 199
        ...
        ["Rogers, Dylan",  "Early",  "Down Lots",     5.9030553e-02, 2.4714603e-01, 115.90306, 24.714603, 25],  # 212
        ...
        ["Rogers, Dylan",  "Middle", "Down Lots",     9.0889670e-03, 1.0888314e-01,  115.90890, 10.888314, 25],  # 222
        ...
        ["Rogers, Dylan",  "Middle", "Up Lots",      -3.1561199e-02, 3.2546340e-02,  115.84388,  3.254634, 25],  # 225
        ...
        ["Sundloff, Colton", "Middle", "Down Lots",    6.901147e-05, 0.05326294, 90.00690, 24.431044, 25],  # 233
        ["Sundloff, Colton", "Middle", "Up Little",    7.036792e-03, 0.16741247, 120.70368, 16.741247, 25],  # 234
        ["Sundloff, Colton", "Middle", "Down Little",  2.916844e-02, 0.11772633, 112.91684, 11.772633, 25],  # 235
        ["Sundloff, Colton", "Late",   "Tight",        2.984216e-02, 0.10473598, 106.98422, 10.473598, 25],  # 236
        ["Sundloff, Colton", "Early",  "Down Little",  4.705457e-02, 0.20967661, 106.70546, 11.772633, 25],  # 237
        ["Sundloff, Colton", "Early",  "Down Lots",    6.391800e-02, 0.24431044, 99.39180, 24.431044, 25],  # 238
